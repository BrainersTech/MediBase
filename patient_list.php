...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0" style="color:#d51709;">HOSPITAL PATIENTS LIST TABLE</h1>
          </div>
                <!-- DataTales Example -->
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" style="color:#d51709;" >
                  ...
                  <tbody>
                    ...
                    <td><a href="admin_patient_more.php"> <button type="button" class="btn btn-outline-danger">More Details</button></a></td>
                    </tr>
                    <tr>
                    <td>
